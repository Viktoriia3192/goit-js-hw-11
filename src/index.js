...
// Приховуємо кнопку "Load More" при початковому завантаженні сторінки
...
async function searchImages() {
  ...
  try {
    ...
    hideLoadMoreBtnIfNeeded(totalHits);
...
function hideLoadMoreBtnIfNeeded(totalHits) {
  const displayedImages = page * 40;
